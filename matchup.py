...
parser.add_argument('name1', nargs='?', help="name of the champion")
parser.add_argument('name2', nargs='?', help="name of the champion")
...
if args.name1:
    champ1 = args.name1.lower()

if args.name2:
    champ2 = args.name2.lower()
